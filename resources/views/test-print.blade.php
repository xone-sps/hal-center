    ...
    <div id="cart-print-area">
        ...
        <table id="table-sales"
            ...
            <tr>
                ...
                <td style="padding: 7px 0; text-align: right; border-bottom: 1px solid #bfbfbf; border-spacing: 0;">1
                </td>
                <td style="padding: 7px 0; text-align: right; border-bottom: 1px solid #bfbfbf; border-spacing: 0;">
                    ₭5,000
                </td>
                <td style="padding: 7px 0; text-align: right; border-bottom: 1px solid #bfbfbf; border-spacing: 0;">
                    0.00%
